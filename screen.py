...
if conf['callback_type'] == "mqtt":
    log_msg("INFO", "[screen] invoke mqtt callback: {}".format(conf['callback_endpoint']))
    ...
    log_msg("INFO", "[screen] invoke websocket callback: {}".format(conf['callback_endpoint']))
...
client.connect(conf['callback_endpoint'], conf['callback_port'])
